...
public class StudentRegistrarDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Tenant>(entity =>
        {
            ...
            entity.Property(e => e.OffboardingStatus).IsRequired();
            entity.Property(e => e.OffboardingReason).HasMaxLength(500);
            entity.Property(e => e.LastOffboardingError).HasMaxLength(2000);
            ...
            entity.Property(e => e.StripeConnectDetailsSubmitted).IsRequired();
            entity.Property(e => e.StripeConnectChargesEnabled).IsRequired();
            entity.Property(e => e.StripeConnectPayoutsEnabled).IsRequired();
